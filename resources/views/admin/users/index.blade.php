                    ...
                    <div class="psa-user-modal-body">
                        <div class="psa-user-form-row">
                            <div class="psa-user-form-group">
                                <label class="psa-user-form-label">First Name <span class="psa-user-required">*</span></label>
                                <input type="text" name="first_name" id="first_name" class="psa-user-form-input" required>
                            </div>
                            <div class="psa-user-form-group">
                                <label class="psa-user-form-label">Last Name <span class="psa-user-required">*</span></label>
                                <input type="text" name="last_name" id="last_name" class="psa-user-form-input" required>
                            </div>
                        </div>
                        
                        <div class="psa-user-form-row">
                            <div class="psa-user-form-group">
                                <label class="psa-user-form-label">Username <span class="psa-user-required">*</span></label>
                                <input type="text" name="username" id="username" class="psa-user-form-input" required>
                            </div>
                            <div class="psa-user-form-group">
                                <label class="psa-user-form-label">Email <span class="psa-user-required">*</span></label>
                                <input type="email" name="email" id="email" class="psa-user-form-input" required>
                            </div>
                        </div>
                        
                        <div class="psa-user-form-row">
                            <div class="psa-user-form-group">
                                <label class="psa-user-form-label" id="passwordLabel">Password <span class="psa-user-required" id="passwordRequired">*</span></label>
                                <input type="password" name="password" id="password" class="psa-user-form-input">
                                <small class="psa-user-form-help" id="passwordHelp">Leave blank to keep current password</small>
                            </div>
                            <div class="psa-user-form-group">
                        ...
                        <div class="psa-user-form-row">
                            <div class="psa-user-form-group">
                                ...
                                <input type="text" name="contact_number" id="contact_number" class="psa-user-form-input">
                            </div>
                            <div class="psa-user-form-group" id="employeeIdDisplay" style="display: none;">
                                <label class="psa-user-form-label">Employee ID</label>
                                <input type="text" id="display_employee_id" class="psa-user-form-input" readonly disabled>
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (createBtn) {
                createBtn.addEventListener('click', function() {
                    ...
                    if (modalTitle) modalTitle.innerHTML = '<i class="fas fa-user-plus"></i> Create New User';
                    
                    const submitBtn = document.getElementById('submitBtn');
                    if (submitBtn) submitBtn.innerHTML = 'Create User';
                    
                    const passwordLabel = document.getElementById('passwordLabel');
                    if (passwordLabel) passwordLabel.innerHTML = 'Password <span class="psa-user-required">*</span>';
            ...
            document.querySelectorAll('.edit-user').forEach(btn => {
                btn.addEventListener('click', async function() {
                    ...
                    try {
                        ...
                        const employeeIdDisplay = document.getElementById('employeeIdDisplay');
                        const displayEmployeeId = document.getElementById('display_employee_id');
                        ...
                        alert('Error loading user data. Please check if the route is properly defined.');
                    }
                });
            });
