...
@section('content')
    <div class="reports-container">
        ...
        <div class="reports-welcome-section">
            <div>
                ...
                <p class="reports-subtitle">Pending and Confirmed Appointments Report</p>
            </div>
        ...
        <div class="reports-stats-grid reports-mb-4">
            <div class="reports-stat-card pending-card">
                <div class="reports-stat-card-content">
                    <div class="reports-stat-info">
                        <h6 class="reports-stat-label">Pending Appointments</h6>
                        <h2 class="reports-stat-value reports-text-warning">{{ $pendingAppointments ?? 0 }}</h2>
                        <p class="reports-stat-trend"><i class="fas fa-clock"></i> Awaiting confirmation</p>
                    </div>
                    <div class="reports-stat-icon-circle warning-bg"><i class="fas fa-clock"></i></div>
                </div>
            </div>
                ...
                <div class="reports-stat-card-content">
                    <div class="reports-stat-info">
                        ...
                        <h2 class="reports-stat-value reports-text-primary">
                            {{ ($pendingAppointments ?? 0) + ($confirmedAppointments ?? 0) }}
                        </h2>
                        <p class="reports-stat-trend"><i class="fas fa-calendar-alt"></i> Active appointments</p>
                    </div>
        ...
        <!-- Status Chart - Only Pending and Confirmed -->
        <div class="reports-chart-card reports-mb-4">
            <div class="reports-chart-header">
                <h5 class="reports-chart-title"><i class="fas fa-chart-bar"></i> Pending vs Confirmed Appointments</h5>
            </div>
    ...
    <script>
        // Appointment Status Chart - Only Pending and Confirmed
        ...
        function exportToCSV() {
            ...
            a.href = url;
            a.download = `pending_confirmed_report_${new Date().toISOString().split('T')[0]}.csv`;
            a.click();
