...
<body>
        ...
        <div class="profile-modal-content">
            ...
            <div class="profile-modal-body">
                ...
                <div class="tab-pane" id="edit-tab">
                    <form id="profileUpdateForm" method="POST" action="{{ route('staff.index') }}"
                ...
                <div class="tab-pane" id="password-tab">
                    <form id="passwordUpdateForm" method="POST" action="{{ route('staff.password.update') }}">
                        @csrf
                        @method('PUT')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Two-Factor Authentication handlers (staff)
            ...
            if (apply2faBtn) {
                apply2faBtn.addEventListener('click', async () => {
                    ...
                    try {
                        const resp = await fetch('{{ route('staff.2fa.toggle') }}', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
            ...
            if (showQrBtn) {
                showQrBtn.addEventListener('click', async () => {
                    ...
                    try {
                        const resp = await fetch('{{ route('staff.2fa.qr') }}');
                        const data = await resp.json();
