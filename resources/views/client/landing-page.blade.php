...
<head>
    ...
    <title>PSA | NationalID Appointment System</title>
        ...
        <div class="container">
            <div class="logo-area">
                ...
                <div class="logo-text">
                    ...
                    <span class="psa-sub">NationalID Appointment System</span>
                </div>
            </div>
            <nav class="main-nav">
        ...
        <section id="home" class="hero-section">
            <div class="container hero-grid">
                <div class="hero-content">
                    <div class="badge">PSA - NationalID Appointment System</div>
    ...
    <div id="appointmentModal" class="appointment-modal-overlay">
        <div class="appointment-modal-container">
            <div class="appointment-modal-header">
                <h3><img src="{{ asset('images/psa.png') }}" alt="PSA" style="height: 40px;">NationalID
