    ...
    (function() {
        ...
        async function loadTimeSlots(date) {
            ...
            try {
                ...
                console.log('Fetching time slots for:', { date, selectedServices });
            ...
            timeSlots.forEach(slot => {
                ...
                if (slot.service_availability) {
                    ...
                    for (const service of selectedServices) {
                        ...
                        const badgeTitle = `${serviceNames[service] || service}: ${availableSlots} slot${availableSlots !== 1 ? 's' : ''} available`;
                    ...
                    const badgeClass = availableSlots > 0 ? 'available' : 'full';
                    serviceBadgesHtml = `<span class="service-badge ${badgeClass}">${availableSlots}</span>`;
