...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('operator.clients.index') }}" class="btn btn-secondary">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($history->appointment)
                                    <a href="{{ route('operator.appointments.show', $history->appointment->id) }}" class="btn btn-sm btn-info">
                                        View Appointment
                                    </a>
                                @endif
                            </td>
...
$(document).ready(function() {
    $('.verify-client').click(function() {
        if(confirm('Verify this client? This will confirm their appointment as well.')) {
            let id = $(this).data('id');
            $.ajax({
                url: `/operator/clients/${id}/verify`,
                method: 'PUT',
    ...
    $('#updateReferenceBtn').click(function() {
        ...
        $.ajax({
            url: `/operator/clients/${id}/reference`,
            method: 'PUT',
            data: { 
