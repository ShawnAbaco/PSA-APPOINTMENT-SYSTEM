...
@section('content')
        ...
        <div class="table-container">
            <div class="table-header">
                ...
                <div class="table-actions">
                    <a href="{{ route('operator.applicants.export') }}" class="btn-icon" title="Export to CSV">
    ...
    <script>
        ...
        function openClientModal(clientId) {
            ...
            fetch(`/operator/applicants/${clientId}/modal`, {
                    headers: {
        ...
        function verifyClientFromModal(clientId) {
            fetch(`/operator/applicants/${clientId}/verify`, {
                    method: 'PUT',
                    headers: {
        ...
        function updateReferenceNumber(clientId, refNumber) {
            fetch(`/operator/applicants/${clientId}/reference`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken,
