...
class OProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('operator.edit')->with('success', 'Profile updated successfully!');
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('operator.index')->with('success', 'Password updated successfully!');
    }
